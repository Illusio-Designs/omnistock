...
const PLANS = [
  {
    ...
    monthlyPrice: 2499, yearlyPrice: 24990, sortOrder: 1,
    maxFacilities: 1, maxSkus: 100000, maxUserRoles: 3, maxUsers: 5, maxOrdersPerMonth: 5000,
    features: {
      returns: 'basic', vms: true, paymentReconciliation: true, mobileApp: true,
  ...
  },
  {
    ...
    monthlyPrice: 7499, yearlyPrice: 74990, sortOrder: 2,
    maxFacilities: 2, maxSkus: 300000, maxUserRoles: 9, maxUsers: 20, maxOrdersPerMonth: 25000,
    features: {
  ...
  },
  {
    ...
    monthlyPrice: 19999, yearlyPrice: 199990, sortOrder: 3,
...
const CONTENT = [
  ...
  { type: 'LANDING_FEATURE_TOOL', title: 'Easy Integration', subtitle: 'Seamlessly connect with 50+ tools like Amazon, Flipkart, Shopify and more — smooth data flow across all your favorite platforms.', data: { visual: 'network' } },

  // ─── Landing page: FAQs ────────────────────────────────────────
  { type: 'LANDING_FAQ', title: 'What types of channels can I connect?', body: 'Over 50+ channels including Amazon, Flipkart, Myntra, Meesho, Nykaa, Blinkit, Zepto, Swiggy Instamart, BB Now, Shopify, WooCommerce, Magento, and 16+ logistics providers like Shiprocket, Delhivery, iThink, Pickrr, NimbusPost, and ClickPost.' },
  ...
  { type: 'HELP_CATEGORY', title: 'Channels & integrations', icon: 'Plug', subtitle: 'Connecting Amazon, Shopify, Shiprocket and 50+ channels.', href: '/resources/help?topic=channels' },
