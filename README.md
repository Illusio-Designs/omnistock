...
1. apply all Prisma migrations to your `uniflo` DB
...
**Default login:** `admin@uniflo.com` / `admin123`
...
`mysql://root@localhost:3306/uniflo` (no password), **not**
`mysql://root:password@localhost:3306/uniflo`.

**`Database 'uniflo' doesn't exist`**
